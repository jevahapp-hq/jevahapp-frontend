            ...
            >
              ...
              {isLoadingPlaylists ? (
                <View style={{ paddingVertical: 32, alignItems: "center" }}>
                  <Text style={{ textAlign: "center", color: "#6B7280", fontFamily: "PlusJakartaSans" }}>
                    Loading playlists...
                  </Text>
                </View>
              ) : playlists.length === 0 ? (
                <Text style={{ textAlign: "center", color: "#6B7280", fontFamily: "PlusJakartaSans", paddingVertical: 32 }}>
                    ...
                    >
                      <View style={{ flex: 1, marginRight: 12 }}>
                        ...
                        {playlist.description && (
                          <Text
                            style={{ fontSize: 14, color: "#6B7280", fontFamily: "PlusJakartaSans", marginTop: 4 }}
                          >
                            {playlist.description}
                          </Text>
                        )}
                        <View style={{ flexDirection: "row", alignItems: "center", marginTop: 8 }}>
                          ...
                          <Text style={{ fontSize: 12, color: "#9CA3AF", fontFamily: "PlusJakartaSans", marginLeft: 4 }}>
