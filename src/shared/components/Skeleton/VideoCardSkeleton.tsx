    ...
    <View className="flex flex-col mb-16" style={{ marginBottom: 64 }}>
      ...
      <View className="w-full h-[400px] overflow-hidden relative">
        ...
        <View className="absolute top-3 left-3">
          <Skeleton dark={dark} width={60} height={24} borderRadius={0} />
        </View>
        ...
        <View className="flex-col absolute mt-[180px] right-4">
          ...
          <View className="flex-col justify-center items-center mb-8">
            <Skeleton dark={dark} width={30} height={30} borderRadius={0} />
            <Skeleton
              dark={dark}
              width={20}
              height={10}
        ...
        <View className="absolute left-3 right-3 px-3" style={{ bottom: 12 }}>
          <View className="flex-row items-center gap-2 mt-2">
            ...
            <View className="flex-1 h-1 bg-white/30 rounded-full relative">
              <Skeleton dark={dark} width="30%" height={4} borderRadius={0} />
            </View>

            {/* Mute Button */}
            <Skeleton dark={dark} width={20} height={20} borderRadius={0} />
          </View>

          {/* Time Labels */}
          <View className="flex-row justify-between mt-1">
            <Skeleton dark={dark} width={40} height={12} borderRadius={0} />
            <Skeleton dark={dark} width={40} height={12} borderRadius={0} />
          </View>
        </View>
      </View>
        ...
        <View className="flex flex-row items-center">
          ...
          <View className="ml-3">
            <View className="flex-row items-center">
              <Skeleton dark={dark} width={80} height={13} borderRadius={0} />
