      ...
      <View style={styles.pollOptions}>
        {poll.options.map((option) => (
          <TouchableOpacity
            ...
            style={[
              styles.pollOption,
              poll.hasVoted && poll.userVote === option.id && styles.selectedOption
            ]}
          ...
          >
            <View style={styles.optionContent}>
              <Text style={[
                styles.optionText,
                poll.hasVoted && poll.userVote === option.id && styles.selectedOptionText
              ]}>
                {option.text}
              </Text>
              {poll.hasVoted && (
  ...
  return (
    <Animated.View style={[styles.container, { transform: [{ translateX: slideAnim }] }]}>
      <SafeAreaView style={styles.safeArea}>
        ...
        {/* Polls List */}
        <ScrollView style={styles.pollsContainer} showsVerticalScrollIndicator={false}>
