...
type ShapeType = 'rectangle' | 'circle' | 'scalloped' | 'square' | 'square2' | 'square3' | 'square4';
...
export default function PostAPrayer() {
  ...
  const handlePost = () => {
    ...
    // Navigate back to prayer wall with the new prayer data
    router.push({
  ...
  const renderScallopedCard = () => {
    ...
    return (
      <View style={styles.scallopContainer}>
        {blobs}
        <View style={[styles.scallopCenter, { backgroundColor: selectedColor }]}>
  ...
  const renderTemplateScalloped = (baseSize: number) => {
    ...
    return (
      <View style={styles.templateScallopContainer}>
        {blobs}
        <View style={[styles.templateScallopCenter, { backgroundColor: selectedColor }]} />
      </View>
    );
  };
        ...
        <View style={styles.previewSection}>
          ...
          <View style={styles.postButtonContainer}>
            <TouchableOpacity
              style={[
                styles.postButton,
                !prayerText.trim() ? styles.disabledButton : styles.activeButton,
              ]}
              onPress={handlePost}
            ...
            >
              <Text style={[
                ...
                !prayerText.trim() ? styles.disabledButtonText : styles.activeButtonText,
              ]}>
                Post
              </Text>
            </TouchableOpacity>
