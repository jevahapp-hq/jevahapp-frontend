...
import { authToast } from "./authToastBus";
      ...
      >
        ...
        >
          ...
          <View className="flex flex-col justify-center items-center w-full">
            ...
            <Text className="text-3xl font-jakarta-bold mb-4 text-[#1D2939] text-center">
              You've got an email
            </Text>

            <Text className="text-lg mb-8 text-[#667085] text-center font-jakarta leading-6 px-4">
            ...
            >
              <Text className="text-white text-center font-jakarta text-[14px] sm:text-[16px] font-semibold">
