      ...
      <Animated.View style={{ position: "absolute", left: 0, right: 0, bottom: 0, transform: [{ translateY }] }}>
        <View style={{ backgroundColor: "#FFFFFF", borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingTop: 12, paddingBottom: 24, maxHeight: SCREEN_HEIGHT * 0.9 }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", paddingHorizontal: 20, paddingBottom: 8 }}>
            <Text style={{ fontSize: 22, fontWeight: "bold", color: "#0F172A", fontFamily: "PlusJakartaSans-Bold", flex: 1 }}>Flag A Group</Text>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 20, paddingBottom: 24 }}>
            <Text style={{ color: "#475467", fontFamily: "PlusJakartaSans-Regular", marginBottom: 16 }}>
            ...
            <TextInput
              ...
              style={{ borderWidth: 1, borderColor: "#D0D5DD", borderRadius: 14, height: 120, paddingHorizontal: 16, paddingTop: 12, textAlignVertical: "top", fontFamily: "PlusJakartaSans-Regular", color: "#101828", marginBottom: 6 }}
            />
            <Text style={{ alignSelf: "flex-end", color: "#667085", fontSize: 10, marginBottom: 16, fontFamily: "PlusJakartaSans-Regular" }}>{`${description.length}/100`}</Text>

            <Text style={{ fontSize: 10, color: "#667085", marginBottom: 8, fontFamily: "PlusJakartaSans-Bold" }}>ADD A SCREENSHOT (OPTIONAL)</Text>
            ...
            <TouchableOpacity onPress={() => { onSubmit({ description, imageUri, isPublic }); handleClose(); setDescription(""); setImageUri(null); }} activeOpacity={0.8} style={{ backgroundColor: "#0C1529", height: 54, borderRadius: 27, alignItems: "center", justifyContent: "center" }}>
              <Text style={{ color: "#FFFFFF", fontSize: 16, fontFamily: "PlusJakartaSans-Bold" }}>Submit</Text>
            </TouchableOpacity>
          </ScrollView>
        </View>
      </Animated.View>
