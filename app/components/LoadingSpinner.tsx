  ...
  switch (type) {
    ...
    case 'overlay':
      return (
        <View style={[
          styles.overlay,
          { backgroundColor: transparent ? 'rgba(0, 0, 0, 0.3)' : backgroundColor }
        ]}>
          <View style={[
            styles.overlayContent,
            {
              backgroundColor: transparent ? 'rgba(255, 255, 255, 0.95)' : 'white',
    ...
    case 'button':
      return (
        <View style={[
          ...
          <ActivityIndicator size="small" color={transparent ? color : 'white'} />
          {showText && text && (
            <Text style={[
              styles.buttonText,
              {
...
export const FullScreenLoader = ({ text, transparent }: { text?: string; transparent?: boolean }) => (
  <LoadingSpinner
    type="fullscreen"
    text={text || 'Loading...'}
...
export const OverlayLoader = ({ text, transparent }: { text?: string; transparent?: boolean }) => (
  <LoadingSpinner
    type="overlay"
...
export const ButtonLoader = ({ text, color }: { text?: string; color?: string }) => (
  <LoadingSpinner
    type="button"
    size="small"
    text={text || 'Loading...'}
...
export const InlineLoader = ({ text, size }: { text?: string; size?: 'small' | 'large' }) => (
  <LoadingSpinner
    type="inline"
    size={size}
    text={text}
...
export const PulseLoader = ({ children, duration = 1000 }: { children: React.ReactNode; duration?: number }) => {
