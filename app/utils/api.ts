...
export const userProfileAPI = {
  /**
   * Fetch current user profile using the new /api/users/me endpoint
   */
  async getCurrentUserProfile(token: string): Promise<any> {
  ...
  /**
   * Get simplified user profile using /api/auth/me endpoint
   */
  async getSimplifiedUserProfile(token: string): Promise<any> {
  ...
  /**
   * Get user profile picture only
   */
  async getProfilePicture(token: string): Promise<{ profilePicture: string | null; hasProfilePicture: boolean }> {
   ...
   */
  async getUserProfileById(userId: string, token: string): Promise<any> {
